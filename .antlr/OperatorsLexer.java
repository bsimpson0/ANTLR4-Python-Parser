...
public class OperatorsLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"MLCOMMENT", "WS", "ID", "STRING", "INTEGER", "PLUS", "MINUS", "MULT", 
			"DIV", "MOD", "EQUALS", "NOTEQUALS", "PLUSEQUALS", "MINUSEQUALS", "TIMESEQUALS", 
			"DIVEQUALS", "COMPEQUALS", "PARENTHESIS", "BRACKET", "GT", "LT", "GTE", 
			"LTE"
		};
	}
